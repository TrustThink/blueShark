...
def injest_filepath(file:str) -> dict
    case_directory_path = f"case/{datetime.datetime.now()}/capture.pcap" 
    Path(directory_path)
   
return case_directory_path

# Step 2 : Determine traffic makeup 

def traffic_makeup(file:str) -> dict
